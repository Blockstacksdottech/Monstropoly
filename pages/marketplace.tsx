  ...
  return (
    <Page>
      ...
      <Row className="d-flex justify-content-between align-items-center mb-3 d-none d-sm-none d-md-none d-lg-block">
        <Col md={12}>
          <Row>
            <Col xs={12} sm={4} md={3} lg={1} className="filter-secion">
              <DropdownButton
            ...
            <Col xs={12} sm={4} md={3} lg={2} className="filtsecinpsec">
              <Form>
                <Form.Group
                  className="mb-0"
            ...
            <Col xs={12} sm={4} md={3} lg={2} className="filter-secion">
              <Form>
                <Form.Group
                  className="mb-0"
                  controlId="exampleForm.ControlInput1"
      ...
      >
        <Modal.Header className="cloasebtn" closeButton></Modal.Header>
        <Modal.Body>
